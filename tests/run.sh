...
${CXX:-c++} -g -std=c++17 -fPIC -Isrc -I../libspnav/src $(pkg-config --cflags Qt6Widgets) \
 tests/test_screen.cc src/profiles.o src/ui.o src/ui.moc.o src/spnavcfg.o res.cc \
...
${CXX:-c++} -g -std=c++17 -fPIC -Isrc -I../libspnav/src $(pkg-config --cflags Qt6Widgets) \
 tests/test_profiles.cc src/profiles.o ../libspnav/libspnav.a $(pkg-config --libs Qt6Widgets) -lX11 -o "$build/test_profiles"
QT_QPA_PLATFORM=offscreen "$build/test_profiles" ${PROFILE_PREVIEW:+"$PROFILE_PREVIEW"}
